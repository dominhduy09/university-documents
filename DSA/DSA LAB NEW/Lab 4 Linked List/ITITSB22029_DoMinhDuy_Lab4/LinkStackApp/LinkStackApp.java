...
class LinkStackApp {
   public static void main(String[] args) {
      LinkStack stack = new LinkStack(); // Create a stack

      // Original list of numbers to reverse
      long[] numbers = { 10, 20, 30, 40, 50 };

      System.out.print("Original list: ");
      for (long num : numbers) {
         System.out.print(num + " ");
         stack.push(num); // Push each number onto the stack
      }
      System.out.println();

      System.out.print("Reversed list: ");
      while (!stack.isEmpty()) {
         System.out.print(stack.pop() + " "); // Pop each number to reverse the list
      }
      System.out.println();
   }
}